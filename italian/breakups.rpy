...
translate italian breakup_lilly_80de82df:
    ...
    c "Devo fare una scelta."

# game/breakups.rpy:27
translate italian breakup_lilly_52ef2e5b:
...
translate italian breakup_lilly_049d1dc1:
...
translate italian breakup_lilly_28bd81ff:
    ...
    l "E ora mi dici che vuoi stare con Céline."
...
translate italian breakup_aven_501fb853:

    # av "Say what you have to say."
    av "Di' quello che hai da dire."

# game/breakups.rpy:62
translate italian breakup_aven_ef51c996:

    # c "Aven, what we have."
    c "Aven, quello che abbiamo."
...
translate italian breakup_ziv_3c747d5f:
    ...
    "Ho obbedito e ho lasciato Ziv nella sua stanza."
...
translate italian breakup_ziv_a9bbe8f1:
    ...
    zi "Sono sicura che la tua nuova conquista sarà molto felice, finché non la lascerai per la prossima."
...
translate italian breakup_raene_83874fc7:
    ...
    ra "Perché no, c'è qualcosa che non va?"
...
translate italian breakup_raene_af3f78fb:
    ...
    c "È solo che sono costretto a fare una scelta e..."
...
translate italian breakup_thyia_0370cdcf:
    ...
    c "C'è qualcun altro nella mia vita."
...
translate italian breakup_vess_9d207ba4:
    ...
    c "Ci ho pensato a lungo e intensamente, ma non possiamo andare avanti così."
...
translate italian breakup_nadya_3efe0ac3:
    ...
    c "Mi rendo conto che potrebbe sembrare insensibile, ma la nostra relazione deve finire."

# game/breakups.rpy:291
translate italian breakup_nadya_cdf6f71a:

    # na "You don’t mince words, do you?"
    na "Non usi mezzi termini, vero?"
...
translate italian breakup_celine_d3e290cc:
    ...
    ce "Esigo che tu me lo dica."

# game/breakups.rpy:380
translate italian breakup_celine_c318e691:

    # ce "I have a right to know!"
    ce "Ho il diritto di sapere!"
